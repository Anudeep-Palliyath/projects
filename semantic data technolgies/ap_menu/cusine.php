      ...
      <html lang="en">
        ...
        <main role="main">
            ...
            <section class="jumbotron text-center">
              <div class="container">
                <h1 class="jumbotron-heading"><span class="badge badge-pill badge-warning"><?php echo $language; ?></span></h1>
      <p>&nbsp;</p>
              </div>
            </section>
            <?php
          ...
          <div class="col-md-4">
                    ...
                    <?php
                    echo  '<img class="card-img-top" src="/ap_menu/images/' . str_replace(' ', '', $row["dishName"]) . '.jpg" style="width:  280px;
