...
<html lang="en">
    ...
    $sort = $_GET["sort"]; 
    $obj =  new Functions();
    $allSortDishes=$obj->sortStarterDishes($sort);
    ?>
    <body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" href="sortStarters.php?sort=high">RATING (High to Low)</a>
    <a class="dropdown-item" href="sortStarters.php?sort=low">RATING (Low to High)</a>
...
<table class="table table-bordered">
  ...
  <div class="row">
    <div class="col-sm">
  <?php
          while( $row = sparql_fetch_array( $allSortDishes) )
